...
A project that connects with the Charge Amps Halo Wallbox API. The APIs support turning on/off lights, add schedules, etc. This project turns the LED light on and off at sunset. The LED light will always turn off at 23:00 hours.
